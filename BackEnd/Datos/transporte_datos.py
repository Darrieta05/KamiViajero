...
class Info_Rutas:
    ...
    #tren = 24, 15, 12, 11
    transportes = {  '1': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':True}],
                    '2': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '3': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '4': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '5': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '6': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '7': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':True}],
                    '8': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '9': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '10': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '11': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '12': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '13': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '14': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '15': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':True}],
                    '16': [{'Taxi':True,'Bus':False,'Tren':False,'Avion':False}],
                    '17': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '18': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '19': [{'Taxi':True,'Bus':False,'Tren':False,'Avion':False}],
                    '20': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '21': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':False}],
                    '22': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':True}],
                    '23': [{'Taxi':True,'Bus':False,'Tren':False,'Avion':True}],
                    '24': [{'Taxi':True,'Bus':True,'Tren':False,'Avion':True}],
